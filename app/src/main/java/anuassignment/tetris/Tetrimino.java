    ...
    private void generateSquares(char type, char orientation) {
        switch ("" + type + orientation) {
            case "IN":
                ...
                squares = new Tuple[]{new Tuple(-1, 0), new Tuple(0, 0), new Tuple(1, 0), new Tuple(2, 0)};

                break;
            case "IE":
                rotationPoints = new Tuple[]{new Tuple(-1, 0), new Tuple(0, 0), new Tuple(0, 0), new Tuple(0, -1), new Tuple(0, -2)};
                squares = new Tuple[]{new Tuple(0, -1), new Tuple(0, 0), new Tuple(0, 1), new Tuple(0, 2)};
                break;
            ...
            case "TN":
                ...
                squares = new Tuple[]{new Tuple(0, -1), new Tuple(-1, 0), new Tuple(0, 0), new Tuple(1, 0)};
                break;

            case "TE":
                rotationPoints = new Tuple[]{new Tuple(0, 0), new Tuple(1, 0), new Tuple(1, 1), new Tuple(0, -2), new Tuple(1, -2)};
                squares = new Tuple[]{new Tuple(0, -1), new Tuple(0, 0), new Tuple(1, 0), new Tuple(0, 1)};
                break;

            case "TW":
                rotationPoints = new Tuple[]{new Tuple(0, 0), new Tuple(-1, 0), new Tuple(-1, 1), new Tuple(0, -2), new Tuple(-1, -2)};
                squares = new Tuple[]{new Tuple(0, -1), new Tuple(-1, 0), new Tuple(0, 0), new Tuple(0, 1)};
                break;

            case "TS":
                rotationPoints = new Tuple[]{new Tuple(0, 0), new Tuple(0, 0), new Tuple(0, 0), new Tuple(0, 0), new Tuple(0, 0)};
                squares = new Tuple[]{new Tuple(-1, 0), new Tuple(0, 0), new Tuple(1, 0), new Tuple(0, 1)};
                break;

            case "LN":
                rotationPoints = new Tuple[]{new Tuple(0, 0), new Tuple(0, 0), new Tuple(0, 0), new Tuple(0, 0), new Tuple(0, 0)};
                squares = new Tuple[]{new Tuple(1, -1), new Tuple(-1, 0), new Tuple(0, 0), new Tuple(1, 0)};
                break;
            ...
            case "LW":
                rotationPoints = new Tuple[]{new Tuple(0, 0), new Tuple(-1, 0), new Tuple(-1, 1), new Tuple(0, -2), new Tuple(-1, -2)};
                squares = new Tuple[]{new Tuple(-1, -1), new Tuple(0, -1), new Tuple(0, 0), new Tuple(0, 1)};
                break;
            ...
            case "JE":
                rotationPoints = new Tuple[]{new Tuple(0, 0), new Tuple(1, 0), new Tuple(1, 1), new Tuple(0, -2), new Tuple(1, -2)};
                squares = new Tuple[]{new Tuple(0, -1), new Tuple(1, -1), new Tuple(0, 0), new Tuple(0, 1)};
                break;
            ...
            case "SE":
                rotationPoints = new Tuple[]{new Tuple(0, 0), new Tuple(1, 0), new Tuple(1, 1), new Tuple(0, -2), new Tuple(1, -2)};
                squares = new Tuple[]{new Tuple(0, -1), new Tuple(0, 0), new Tuple(1, 0), new Tuple(1, 1)};
                break;

            case "SN":
                rotationPoints = new Tuple[]{new Tuple(0, 0), new Tuple(0, 0), new Tuple(0, 0), new Tuple(0, 0), new Tuple(0, 0)};
                squares = new Tuple[]{new Tuple(0, -1), new Tuple(1, -1), new Tuple(-1, 0), new Tuple(0, 0)};
                break;

            case "SW":
                rotationPoints = new Tuple[]{new Tuple(0, 0), new Tuple(-1, 0), new Tuple(-1, 1), new Tuple(0, -2), new Tuple(-1, -2)};
                squares = new Tuple[]{new Tuple(-1, -1), new Tuple(-1, 0), new Tuple(0, 0), new Tuple(0, 1)};
                break;
            ...
            case "ZN":
                rotationPoints = new Tuple[]{new Tuple(0, 0), new Tuple(0, 0), new Tuple(0, 0), new Tuple(0, 0), new Tuple(0, 0)};
                squares = new Tuple[]{new Tuple(-1, -1), new Tuple(0, -1), new Tuple(0, 0), new Tuple(1, 0)};
                break;

            case "ZE":
                rotationPoints = new Tuple[]{new Tuple(0, 0), new Tuple(1, 0), new Tuple(1, 1), new Tuple(0, -2), new Tuple(1, -2)};
                squares = new Tuple[]{new Tuple(1, -1), new Tuple(0, 0), new Tuple(1, 0), new Tuple(0, 1)};
                break;

            case "ZW":
                rotationPoints = new Tuple[]{new Tuple(0, 0), new Tuple(-1, 0), new Tuple(-1, 1), new Tuple(0, -2), new Tuple(-1, -2)};
                squares = new Tuple[]{new Tuple(0, -1), new Tuple(-1, 0), new Tuple(0, 0), new Tuple(-1, 1)};
                break;

            case "ZS":
                rotationPoints = new Tuple[]{new Tuple(0, 0), new Tuple(0, 0), new Tuple(0, 0), new Tuple(0, 0), new Tuple(0, 0)};
                squares = new Tuple[]{new Tuple(-1, 0), new Tuple(0, 0), new Tuple(0, 1), new Tuple(1, 1)};
                break;

            default:
                rotationPoints = new Tuple[]{new Tuple(0, 0), new Tuple(0, 0), new Tuple(0, 0), new Tuple(0, 0), new Tuple(0, 0)};
                squares = new Tuple[]{new Tuple(-1, -1), new Tuple(0, -1), new Tuple(-1, 0), new Tuple(0, 0)};
                break;
        }
